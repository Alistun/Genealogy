...
namespace 电子族谱系统
{
    public partial class member : Form
    {
        ...
        {
            string connString = @"Data Source = .; Initial Catalog = 电子族谱系统数据库; User ID = sa; Password = 12345678999";
            string sql = @"INSERT INTO 世系表(Tree_id,Tree_list,Tree_order,Tree_dishu,User_id,Fam_id) VALUES('" + textBox11.Text + "','" + textBox2.Text + "','" + textBox12.Text + "','" + textBox13.Text + "','" + textBox1.Text + "','" + textBox9.Text + "')";
            SqlConnection conn = new SqlConnection(connString);
            conn.Open();
